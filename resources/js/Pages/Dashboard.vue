...
defineProps<{
    listings: PaginatedListings | null;
    status?: string;
}>();

const deleteListing = (id: number): void => {
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-4 text-xs">
                        <p>
                            Approved
                            <Fa :icon="['fas', 'fa-circle-check']" class="text-green-500" />
                        </p>
                        <p>
                            Pending approval
                            <Fa :icon="['fas', 'fa-circle-xmark']" class="text-red-500" />
                        </p>
                    </div>
                </div>
